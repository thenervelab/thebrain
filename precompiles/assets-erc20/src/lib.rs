...
// Purestake Inc. pallet-evm-precompileset-assets-erc20 package used in Hippius Network in terms of
// GPLv3.
...
/// 1024-2047 Precompiles that are not in Ethereum Mainnet but are neither Hippius specific
