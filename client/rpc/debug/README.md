...
Tracing wasms for each Hippius/river/base runtime versions live at `Hippius-runtime-overrides` repository in github.

Tracing functionality in Hippius makes heavy use of [environmental](https://docs.rs/environmental/latest/environmental/):
...
- This allows:
  1. Listen to new events from the evm in the Hippius runtime wasm.
