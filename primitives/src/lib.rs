...
/// Hippius parachain time-related
pub mod time {
	...
	pub const SECONDS_PER_BLOCK: Moment = 2;
	...
	pub const MONTH: BlockNumber = DAYS * 30;
...
/// Fee config for hippius parachain
pub mod fee {
	use super::*;
...
pub mod democracy {
	...
	pub const MINIMUM_DEPOSIT: Balance = 1000 * UNIT; // 1000 hAlpha
...
pub const MAINNET_LOCAL_SS58_PREFIX: u16 = 42;
pub const MAINNET_LOCAL_CHAIN_ID: u64 = MAINNET_LOCAL_SS58_PREFIX as u64;