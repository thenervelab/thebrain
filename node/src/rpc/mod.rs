...
use hippius_runtime::BlockNumber;

// Runtime
#[cfg(not(feature = "testnet"))]
use hippius_runtime::{AccountId, AssetId, Balance, Hash, Index };
#[cfg(feature = "testnet")]
use hippius_testnet_runtime::{AccountId, AssetId, Balance, Hash, Index};
