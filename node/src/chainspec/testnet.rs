...
use hippius_primitives::TESTNET_LOCAL_SS58_PREFIX;
use hippius_testnet_runtime::{
...
const VALIDATOR_SR25519: &str = "5CcSgTwvLZ7YPx8wYkhPWQBB9Wmc4VKm8w53Rs58FoQFA9LR";
...
fn get_sr25519_from_ss58(ss58: &str) -> sr25519::Public {
    sr25519::Public::from_ss58check_with_version(ss58).expect("Invalid SS58 address").0
}

/// Helper function to get ed25519 public key from SS58 string
fn get_ed25519_from_ss58(ss58: &str) -> ed25519::Public {
    ed25519::Public::from_ss58check_with_version(ss58).expect("Invalid SS58 address").0
}
...
) -> hippius_testnet_runtime::opaque::SessionKeys {
	hippius_testnet_runtime::opaque::SessionKeys { babe, grandpa, im_online }
}
