...
use frame_system::offchain::{SendTransactionTypes, SigningTypes};
use sp_consensus_babe::{AllowedSlots, AuthorityId as BabeId, BabeEpochConfiguration};
use sp_core::Pair;
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	keystore
		.sr25519_generate_new(crate::KEY_TYPE, Some(b"//Alice"))
