...
pub mod pallet {
    ...
    #[pallet::config]
    pub trait Config: frame_system::Config +  pallet_balances::Config + pallet_credits::Config{
    ...
    #[pallet::storage]
    pub type AlphaBalances<T: Config> = StorageMap<_, Blake2_128Concat, T::AccountId, u128, ValueQuery>;
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn confirm_mint_alpha(
            ...
            if confirmations.len() as u32 >= min_signatures {
                ...
                let _ = pallet_balances::Pallet::<T>::deposit_creating(&pallet_account, amount.try_into().unwrap_or_default());
