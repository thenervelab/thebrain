...
pub mod pallet {
    ...
    pub trait Config: frame_system::Config + SendTransactionTypes<Call<Self>> +
                      frame_system::offchain::SigningTypes  + pallet_marketplace::Config + pallet_utils::Config + pallet_compute::Config {    
                    ...
                    if let Some(compute_request) = compute_request {
                        ...
                        match serde_json::from_slice::<TechnicalDescription>(&compute_request.plan_technical_description) {
                            Ok(tech_desc) => {
                                ...
                                log::info!("restore JSON Snapshot Payload: {}", json_string);
