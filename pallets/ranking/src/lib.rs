...
pub mod pallet {
   ...
   pub type RankDistributionLimit<T: Config<I>, I: 'static = ()> = StorageValue<_, u16, ValueQuery>;   
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		pub fn update_rankings(origin: OriginFor<T>, all_nodes_ss58 : Vec<Vec<u8>>,  weights: Vec<u16>, node_ids: Vec<Vec<u8>>, node_types: Vec<NodeType> , _block_number: BlockNumberFor<T>) -> DispatchResult {
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		pub fn save_rankings_update(weights: Vec<u16>, all_nodes_ss58: Vec<Vec<u8>>, node_ids: Vec<Vec<u8>>, node_types: Vec<NodeType>, block_number: BlockNumberFor<T>) {
